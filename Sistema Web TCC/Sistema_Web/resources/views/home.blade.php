        ...
        <div class="col s12">
          <div class="card">
            ...
            <div class="card-content">
              <p>
                Se estiver perdido ou precisar de ajuda simplesmente clique abaixo e tenha suas
      ...
      <div class="row center">
        <div class="col s12">
          <div class="card">
            ...
            <div class="card-content">
              <p>
              Está curioso sobre como esse projeto foi feito? De uma olhada na pagina "Sobre Nos"
              </p>
            </div>
            <div class="card-action">
