...
<div class="container">
  ...
  <div class="row">
    <ul class="collapsible" data-collapsible="accordion">
      ...
      <li>
        <div class="collapsible-header"><i class="material-icons">chevron_right</i>Como procurar por instituições?</div>
        <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
      </li>
      <li>
      ...
      <li>
        <div class="collapsible-header"><i class="material-icons">chevron_right</i>O que é uma instuição de voluntários?</div>
        <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
      </li>
    </ul>
    </div>
